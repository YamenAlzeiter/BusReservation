    ...
    <div class="container">
        <div class="content">
            ...
            <div class="seatview">
                ...
                <div class="row">
                        <h1>reserved seats: </br>
                        <?php
                             $myArray = file('reserved.txt');
                    ...
                    <div class="row">
                        ...
                        <div class="column available" id = "J3"><input class = "checkbox-in" type="radio" name= "seat" value = "J2" > <label for="J2"> J2</label></div>
